...
func (sn *storageNode) Service() {
	...
	var utp *uploadTaskPool.UploadTaskPool = uploadTaskPool.New(500, time.Second*10, time.Millisecond*10)
...
func Report(sn *storageNode, rce *rc.RecoverEngine, pool *uploadTaskPool.UploadTaskPool) {
	...
	statistics.DefaultStat.NetLatency = int64(pool.NetLatency.Avg())
	statistics.DefaultStat.DiskLatency = int64(pool.DiskLatency.Avg())
